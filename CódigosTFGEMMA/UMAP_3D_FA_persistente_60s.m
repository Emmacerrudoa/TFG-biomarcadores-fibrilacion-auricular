...
archivo_tabla = ...
    'C:\Users\Emma\Documents\MATLAB\BIOMARCADORES_60s_FA_PERSISTENTE\biomarcadores_FA_persistente_60s.xlsx';
...
title( ...
    'UMAP temporal 3D en FA persistente', ...
    'FontSize', 17, ...
    'FontWeight', 'normal');
...
archivo_salida = fullfile( ...
    carpeta_salida, ...
    'UMAP_3D_FA_PERSISTENTE_MINUTO_1_vs_MINUTO_3.png');
