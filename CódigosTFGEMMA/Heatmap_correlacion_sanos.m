...
%   T_StdMedia
%
% No se incluyen las variables de control:
%   N_R, N_RR, P_NumOndas y T_NumOndas.
%
% No se seleccionan biomarcadores por significación estadística,
% porque el grupo sano se utiliza como control de estabilidad temporal.
%
...
archivo_png = fullfile( ...
    carpeta_base, ...
    'Heatmap_correlacion_biomarcadores_sanos.png');
...
% Nombres mostrados en el heatmap.
% Deben seguir exactamente el mismo orden que "biomarcadores".
etiquetas = { ...
    'RR mean', ...
    'SDNN', ...
    'RMSSD', ...
...
h.Title = ...
    'Correlación entre biomarcadores en sujetos sanos';
